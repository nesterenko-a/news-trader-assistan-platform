...
**Статус:** утверждено v1.25 (добавлен раздел «Реальное время»: SSE `GET /v1/realtime/stream` и настройки `/admin/realtime/save`; см. [24-market-realtime.md](./24-market-realtime.md))
