...
| `scripts/daily_pipeline.py` | Ежедневный конвейер: новости → цены → генерация стратегий. Окно сбора новостей: `--days N` / `--from YYYY-MM-DD`; Telegram-каналы: `--telegram`; сайты компаний: `--sites` |
