...
**Повтор фаз:** параметр `--from-phase N` (1–5) запускает конвейер **с фазы N**, пропуская уже успешно завершённые (в логе: «Пропускаю фазы 1..N−1»). В админке — поле «Начать с фазы (1–5)» в карточке «Ежедневный конвейер». Подфазы 1b/1c (Telegram/сайты) следуют за фазой 1 и пропускаются вместе с ней.
