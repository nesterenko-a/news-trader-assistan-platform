...
- При **недоступности БД** приложение не падает: стартует, а страницы, требующие данных, возвращают дружелюбную страницу «База данных недоступна» (503) вместо Internal Server Error; после восстановления БД монитор записывает критическое уведомление о простое в «Внимание».
