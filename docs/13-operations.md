...
- Фоновый **монитор здоровья** (проверка БД, LLM, Telegram) наполняет «Внимание»: недоступность БД или ИИ-анализа — критично, Telegram-бота — некритично (см. [14-web-interface.md](./14-web-interface.md)).
