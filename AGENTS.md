...
6. Перед реализацией задачи из дорожной карты проверить достаточность документации по ней (обоснование, FR/UC, модель данных, API, UI); при нехватке — сначала зафиксировать дизайн в `docs/`, затем реализовывать.
