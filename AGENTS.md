...
Полная спецификация проекта — в `docs/` (начните с `docs/README.md`; комплект из 25 документов, текущая версия v1.148). Правила работы — в `docs/16-working-process.md` — **обязательны к выполнению**.
...
- Документация: комплект **v1.148**; актуальные расширенные версии: 09 — v1.17, 10 — v1.28, 12 — v1.54, 13 — v1.56, 14 — v1.86, 19 — v1.23, 23 — реализовано v1.9, 24 — реализовано v1.4, 25 — реализовано v1.15; остальные см. в шапках документов.
