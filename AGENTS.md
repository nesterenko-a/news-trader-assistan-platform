...
Полная спецификация проекта — в `docs/` (начните с `docs/README.md`; комплект из 23 документов, текущая версия v1.133). Правила работы — в `docs/16-working-process.md` — **обязательны к выполнению**.
...
- Документация: комплект **v1.133**; версии: 09 — v1.17, 10 — v1.23, 12 — v1.47, 13 — v1.54, 14 — v1.76, 19 — v1.22, 23 — v1.0 (ТЗ «Теханализ в LLM», на согласовании), остальные см. шапки.
- Roadmap (12): этап 0 завершён; этап 1 — срезы 1–6 (включая бэктест «на момент T») + News Sources Manager (страница `/news`, ленты из БД); этап 2 — начат (paper trading, контраргументы/риски, веса факторов, OI, Volume Profile, EMA/MACD, поддержка/сопротивление, E2E-тесты веб-интерфейса `pytest -m e2e`); **Теханализ в LLM** — ТЗ в `docs/23-tech-analysis-llm.md` (на согласовании), недостающие индикаторы (RSI, базис) — ТЗ в `docs/19` §8.15–8.16.
