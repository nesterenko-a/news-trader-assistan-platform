...
- Документация: комплект **v1.161**; актуальные расширенные версии: 09 — v1.17, 10 — v1.29, 12 — v1.60, 13 — v1.59, 14 — v1.92, 16 — v1.10, 17 — v1.16, 18 — v1.2, 19 — v1.23, 23 — реализовано v1.11, 24 — реализовано v1.6, 25 — реализовано v1.15, 26 — утверждено, реализация отложена v1.2, 27 — частично реализовано v1.2; остальные см. в шапках документов.
