...
Полная спецификация проекта — в `docs/` (начните с `docs/README.md`; комплект из 25 документов, текущая версия v1.151). Правила работы — в `docs/16-working-process.md` — **обязательны к выполнению**.
...
4. После завершения и проверки стабильной значимой группы изменений подготовить рекомендуемый аннотированный git-тег, но создавать или публиковать его только по явному запросу пользователя после его ручной проверки (`docs/16-working-process.md` §3.1).
...
- Документация: комплект **v1.166**; актуальные расширенные версии: 09 — v1.17, 10 — v1.29, 12 — v1.65, 13 — v1.59, 14 — v1.97, 16 — v1.10, 17 — v1.16, 18 — v1.2, 19 — v1.26, 21 — v1.17, 23 — реализовано v1.11, 24 — реализовано v1.6, 25 — реализовано v1.15, 26 — реализовано v1.4, 27 — частично реализовано v1.3, 28 — реализовано v1.1, 29 — на согласовании v1.0; остальные см. в шапках документов.
