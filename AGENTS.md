...
- Документация: комплект **v1.172**; актуальные расширенные версии: 09 — v1.17, 10 — v1.29, 12 — v1.66, 13 — v1.59, 14 — v1.99, 16 — v1.12, 17 — v1.16, 18 — v1.2, 19 — v1.29, 21 — v1.20, 23 — реализовано v1.11, 24 — реализовано v1.7, 25 — реализовано v1.16, 26 — реализовано v1.4, 27 — частично реализовано v1.3, 28 — реализовано v1.3, 29 — реализовано v1.1; остальные см. в шапках документов.
