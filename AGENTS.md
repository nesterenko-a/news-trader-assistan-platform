...
- Документация: комплект **v1.157**; актуальные расширенные версии: 09 — v1.17, 10 — v1.29, 12 — v1.58, 13 — v1.58, 14 — v1.91, 18 — v1.2, 19 — v1.23, 23 — реализовано v1.11, 24 — реализовано v1.6, 25 — реализовано v1.15, 26 — утверждено, реализация отложена v1.2, 27 — на согласовании v1.0; остальные см. в шапках документов.
