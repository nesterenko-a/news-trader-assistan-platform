...
- Документация: комплект **v1.163**; актуальные расширенные версии: 09 — v1.17, 10 — v1.29, 12 — v1.62, 13 — v1.59, 14 — v1.94, 16 — v1.10, 17 — v1.16, 18 — v1.2, 19 — v1.24, 23 — реализовано v1.11, 24 — реализовано v1.6, 25 — реализовано v1.15, 26 — реализовано v1.4, 27 — частично реализовано v1.3, 28 — на согласовании v1.0; остальные см. в шапках документов.
